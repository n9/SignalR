...
namespace Microsoft.AspNet.SignalR
{
    ...
    public abstract class Hub : IHub
    {
        ...
        /// <summary>
        /// Internal property used to back <see cref="IHub.Clients"/>. This is meant to be consumed by
        /// <see cref="Hub"/> and <see cref="Hub{T}"/> in order to avoid a possible stack overflow.
        /// https://github.com/SignalR/SignalR/issues/3228
        /// </summary>
        //internal IHubCallerConnectionContext<dynamic> ClientsInternal { get; set; }
